...
var FileDropper = function (_Component) {
	_inherits(FileDropper, _Component);

	function FileDropper() {
		_classCallCheck(this, FileDropper);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(FileDropper).apply(this, arguments));
	}
