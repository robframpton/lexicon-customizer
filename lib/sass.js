...
module.exports = {
	...
	_getUserVariables: function(variables) {
		...
		var userBootstrapVariables = this._getUniqueVariables(variables.bootstrap, bootstrapBaseVariables);
		var userLexiconVariables = this._getUniqueVariables(variables.lexicon, lexiconBaseVariables);

		return Object.assign({}, userBootstrapVariables, userLexiconVariables);
	},
